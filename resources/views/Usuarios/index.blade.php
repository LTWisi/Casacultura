    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="userSettings.blade.php">
        ...
        <div id="carousel" class="carousel slide carousel" data-ride="carousel" data-pause="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="resources/1.png" class="d-block w-100" alt="Family">
                </div>
                <div class="carousel-item">
                    <img src="resources/2.png" class="d-block w-100" alt="Students">
                </div>
                <div class="carousel-item">
                    <img src="resources/3.png" class="d-block w-100" alt="Programmer">
                </div>
                <div class="overlay">
                    <div class="container">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-4 col-sm-12 col-md-6 text-center">
                    <div class="card">
                        <img src="resources/avatar.jpg" class="card-img-top" alt="Foto Sergio">
                        <div class="card-body">
                ...
                <div class="col-12 col-lg-4 col-sm-12 col-md-6 text-center">
                    <div class="card">
                        <img src="resources/avatar.jpg" class="card-img-top" alt="Foto Luis">
                        <div class="card-body">
